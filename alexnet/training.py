...
model_save_path = "../models/AlexNet_v3_10epc.pt"
...
# แก้ไข model layer จาก 1000 out เป็น 10 out
...
print(f"\nStart training \033[91mAlexNet\033[0m model \033[91m{num_epochs}\033[0m epochs\n")
